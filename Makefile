...
OBJS ?= main.c event.c sector.c order.c research.c unit.c fleet.c world.c ui.c screen_manager.c screen_map.c screen_system.c screen_fleet.c screen_cargo.c
